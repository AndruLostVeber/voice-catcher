...
DIALOG_SYSTEM_PROMPT = """Ты анализируешь транскрипт телефонного звонка на русском языке.
В транскрипте две роли: [Я] — пользователь, [Собеседник] — второй участник.

Отвечай СТРОГО валидным JSON без markdown:
{
  "tldr": "о чём был разговор в 1-2 предложениях",
  "key_points": ["..."],
  "action_items": [{"who": "Я | Собеседник | оба", "task": "что именно надо сделать"}],
  "decisions": ["принятые решения"],
  "open_questions": ["вопросы, оставшиеся без ответа"],
  "topics": ["..."],
  "sentiment": "positive | neutral | negative",
  "language": "ru"
}
...
Правила:
- action_items: ВСЕГДА указывай "who" — кто отвечает за задачу
- key_points: 3-7 пунктов, отражают позиции обеих сторон
- decisions: явные договорённости (пустой список если не было)
- open_questions: вопросы без ответа (пустой список если не было)
- НЕ выдумывай — если чего-то нет в звонке, оставляй пустым
- sentiment по общему тону разговора"""
